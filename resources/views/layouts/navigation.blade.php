<v-app-bar app>
    ...
    <v-toolbar-items class="hidden-xs-only">
        ...
        @else
            ...
            <v-btn href="/cart">
                <v-icon class="mdi mdi-cart"></v-icon>My Cart @if (Auth::user()->cart->cartDetails->count() > 0)<v-badge class="mx-2" content="{{ Auth::user()->cart->cartDetails->count() }}"></v-badge>@endif
            </v-btn>
